...
def run_lda(data_dir, num_topics, use_mini_batches, batch_size, epochs,visualize, model_file, create_dict, dict_file, load_dbs):
...
if __name__ == '__main__':
  ...
  parser.add_argument("--create_dict", help="Load a dictionary or create a new dictionary", action='store_true')
  parser.add_argument("--load_dbs", help="Load a database or create a new database", action='store_false')
  args = parser.parse_args()
  run_lda(args.data_directory, args.num_topics, args.use_mini_batches, args.batch_size, args.num_epochs, args.visualize, args.model_file, args.create_dict, args.dict_file, args.load_dbs)
